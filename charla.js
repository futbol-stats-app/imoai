...
+ '</div>'
+ '<p class="cha-pie">' + (document.getElementById("calculadora") ? 'Los importes y los plazos no los da ella: los da la calculadora de aqui abajo, con la norma oficial al lado.' : 'Los importes y los plazos que no tiene delante te los manda confirmar: compru&eacute;balos siempre en la fuente oficial.') + ' &middot; <a href="privacidad.html">Privacidad</a></p>';
